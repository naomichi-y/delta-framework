 ...
 * @package controller.listener
 */
class Delta_PerformanceListener extends Delta_Object implements Delta_ControllerListener
{
  /**
   * @var int
   */
  ...
  /**
   * @see Delta_ControllerListener::getListenerPoints()
   * @author Naomichi Yamakita <naomichi.y@delta-framework.org>
   */
  public function getListenerPoints()
  {
    return array('terminate');
  }

  /**
   * @see Delta_FrontControllerDelegate::terminate()
   * @author Naomichi Yamakita <naomichi.y@delta-framework.org>
   */
