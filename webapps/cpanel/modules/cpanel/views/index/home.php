...
<html lang="ja">
  ...
  <body>
    ...
    <div id="contents">
      ...
      <ul>
        <li><?php echo $html->link('キャッシュ管理', array('route' => 'cpanelActionRoute', 'controller' => 'cache', 'action' => 'status')) ?></li>
        <li><?php echo $html->link('パフォーマンスアナライザ', 'PerformanceAnalyzer') ?></li>
        <li><?php echo $html->link('DAO ジェネレータ', array('route' => 'cpanelActionRoute', 'controller' => 'dao', 'action' => 'form')) ?></li>
      </ul>
    </div>
    <footer>
